...
const Main =()=>{
 const [data,setData]=useState([
  ...
  {headline:"PAKISTAN CRICKET NEWS",image:"./Image/Shaheen.jpg", description:"Shaheen best bowling figure against India amazing spell from Shaheen Shah Afridi",news:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer consectetur porttitor ",img:"./Shadab.jpg",describe:"Nunc vel enim nulla. Aenean et lacinia lectus. Phasellus magna lectus, gravida ut sodales quis,"},


  {
      headline:"AUSTRILIAN CRICKET NEWS", image:"./Image/Usman.jpg",description:"Usman khawaja makes his 10th test century against England in home series test match",news:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer consectetur porttitor",img:"./Starc.jpg",describe:"Nunc vel enim nulla. Aenean et lacinia lectus. Phasellus magna lectus, gravida ut sodales quis," },
